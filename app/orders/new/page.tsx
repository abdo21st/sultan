                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                name="customerName"
                                type="text"
                                className="w-full rounded-lg border border-input bg-background/50 px-4 py-2.5 text-sm transition-all focus:border-primary focus:ring-1 focus:ring-primary outline-none"
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                type="tel"
                                dir="ltr"
                                className="w-full rounded-lg border border-input bg-background/50 px-4 py-2.5 text-sm transition-all focus:border-primary focus:ring-1 focus:ring-primary outline-none font-mono"
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            name="description"
                            rows={3}
                            className="w-full rounded-lg border border-input bg-background/50 px-4 py-2.5 text-sm transition-all focus:border-primary focus:ring-1 focus:ring-primary outline-none resize-none"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="space-y-2">
                            ...
                            <input
                                ...
                                className="w-full rounded-lg border border-input bg-background/50 px-4 py-2.5 text-sm transition-all focus:border-primary focus:ring-1 focus:ring-primary outline-none"
                            />
                            <p className="text-xs text-muted-foreground">يجب أن لا يكون التاريخ في الماضي</p>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-end gap-3 pt-6 border-t border-border">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="px-6 py-2.5 text-sm font-medium text-white bg-primary hover:bg-amber-600 rounded-lg shadow-lg shadow-primary/20 transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none"
                        >
